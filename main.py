...
parser.add_argument('--data_root_dir', type=str, default='./result/features/virchow2',
                    help='data directory')
...
parser.add_argument('--result_dir', default='./PathMoE/results')
parser.add_argument('--split_dir', type=str, default='./PathMoE/splits/task_pcr_vs_no_100',
...
parser.add_argument('--exp_code', type=str, default='task_pcr_vs_no', help='experiment code for saving results')
parser.add_argument('--weighted_sample', action='store_true', default=True, help='enable weighted sampling')
parser.add_argument('--model_size', type=str, choices=['small', 'big'], default='small', help='size of model, does not affect mil')
parser.add_argument('--task', type=str,default='task_pcr_vs_no', choices=['task_tumor_vs_normal'])
