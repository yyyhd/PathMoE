...
Accurate prediction of neoadjuvant chemotherapy (NAC) response is crucial for optimizing treatment and improving outcomes in breast cancer. Here, we present PathMoE, a multistain mixture-of-experts model that integrates paired hematoxylin and eosin (H&E) and immunohistochemistry slides (ER, PR, HER2, Ki-67) to predict pathological complete response and stratify patient prognosis. Built upon a pathology foundation model, PathMoE incorporates stain-specific expert network and an adaptive gating mechanism to fuse modality-specific representations, enabling biologically informed and robust predictions. PathMoE was developed and validated on 12,150 multi-stain WSIs from 2,430 patients across five medical centers, including three independent external and one prospective cohorts. PathMoE achieved up to 22.5% and 13.7% higher accuracy than clinicopathological and single-stain models, respectively, and maintained consistent performance across molecular subtypes and lymph-node statuses.
